...
<div class="card-header">
    <h3 class="card-title">Tổng có <?php echo e(count($Brand)); ?> hãng xe  </h3>
</div>
<table class="table table-stripped">
       ...
       <?php $__currentLoopData = $Brand; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td>
                    <a href="<?php echo e(BASE_URL . 'brand/edit/' . $pro->id); ?>" class="btn btn-sm btn-success">Sửa</a> &nbsp;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\php\hoc-tap\php2\pt14314-assigment\views/brand/index.blade.php ENDPATH**/ ?>